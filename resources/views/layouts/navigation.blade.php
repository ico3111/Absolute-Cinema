<nav x-data="{ open: false }" class="h-10"style="background-color: #7C0B0B;">
    <!-- Primary Navigation Menu -->
    <div class="max-w-1/1 mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Logo -->
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="https://media.tenor.com/SeLBRCUiQaoAAAAe/absolute-cinema-cinema.png" alt="Absolute" class="block h-9 w-15 h-14 fill-current" />
                    </a>
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-tborder-gray-600">
            <div class="px-4">
                @if (Auth::user())
